...
import static org.sample.checkers.importer.SubdivisionMesh.BoundaryMode;
import static org.sample.checkers.importer.SubdivisionMesh.MapBorderMode;
        ...
        if (isWireframe) {
            ...
            if (facesDirty) {
                ...
                for (int f = 0; f < pmesh.faces.length; f++) {
                    ...
                    int currentSmoothGroup = pmesh.getFaceSmoothingGroups().size() > f ? pmesh.getFaceSmoothingGroups().get(f) : 0;
