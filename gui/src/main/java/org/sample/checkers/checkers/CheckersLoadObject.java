...
public class CheckersLoadObject extends MeshView {
    ...
    public CheckersLoadObject(String modelName, int size) {

        Model model = null;

        CheckersLoadModel checkersLoadModel = CheckersPropertyUtil.getModel();
        model = checkersLoadModel.getModel().get(modelName);
