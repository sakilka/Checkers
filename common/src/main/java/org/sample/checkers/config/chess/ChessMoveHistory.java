...
public class ChessMoveHistory {
    ...
    private List<ChessMovePosition> moves;

    private boolean castlingWhiteDone;
    private boolean castlingBlackDone;
    private ChessSide onMove;

    public ChessMoveHistory(List<ChessMovePosition> moves) {
        this.moves = moves;
        this.castlingWhiteDone = false;
        this.onMove = WHITE;
    }

    public List<ChessMovePosition> getMoves() {
        return moves;
    }

    public void setMoves(List<ChessMovePosition> moves) {
        this.moves = moves;
    }

    public void addMove(ChessMovePosition move) {
    ...
    private boolean isFirstMove(ChessMovePosition move) {
    ...
    public ChessBoardPositions getCurrentBoardFromHistory() {
        ...
        for (ChessMovePosition move : moves) {
    ...
    public ChessBoardPositions getCurrentBoardFromHistoryAndWithMove(ChessMovePosition move) {
